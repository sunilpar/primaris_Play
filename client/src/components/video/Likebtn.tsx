...
function Likebtn({ video_id }: LikebtnProps) {
  ...
  return !loading ? (
    <>
      ...
      <div className="">
        <button
          className=" hover:scale-105 rounded-2xl opacity-70 mt-[18px] ml-5 "
    ...
    <>
      <div className="rounded-l-full bg-[#242526] hover:bg-[#525353] pluse hover:scale-105  px-6 font-semibold mt-[14.2px] opacity-60"></div>

      <button className="rounded-r-full bg-[#242526] hover:bg-[#525353] pluse hover:scale-105 px-6 py-1 font-semibold mt-[14.2px] opacity-60"></button>

      <div className="rounded-full ml-5 bg-[#242526] hover:bg-[#525353] pluse hover:scale-105  px-6 py-4 font-semibold mt-[14.2px] opacity-60"></div>
    </>
  );
}
