...
//       setError("make sure the video is not larger then 150mb ");
//     } finally {
//       setLoading(false);
//     }
//   };
...
//           </div>
//           {/* upload */}
//           <div className="bg-black lg:h-[94%] lg:w-[700px] h-[70%] w-[300px] min-w-[340px] rounded-2xl mt-10 ring-2 ring-[#c4ab88] z-50">
...
//                 <input type="radio" {...register("ispublic", {})} />
//                 {errors.ispublic && (
//                   <p className="text-red-600">{errors.ispublic.message}</p>
//                 )}
    ...
    <>
      ...
      >
        ...
        <div className="flex lg:justify-between align-middle w-full flex-wrap justify-center ">
          ...
          {/* upload */}
          <div className="bg-black opacity-80 lg:h-[94%] lg:w-[700px] h-[70%] w-[300px] min-w-[340px] rounded-2xl mt-10 ring-2 ring-[#c4ab88] z-50">
            {error && <p className="text-red-600 mt-8 text-center">{error}</p>}
            <form onSubmit={handleSubmit(onSubmit)}>
              <div className="box flex justify-center flex-col">
                <div className="uploads flex flex-row flex-wrap justify-center">
